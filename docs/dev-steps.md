...
このdev-stepsの開発を終えての振り返りです。

- クラウド学習の一環として、初めて Firebase を用いた個人開発プロジェクトを開始
- 1週間程度、毎朝30分〜1時間の作業で付箋 Web アプリの MVP を設計・デプロイまで完了
- Copilot Chat (gpt-4.1 API) と VSCode の活用で、実装・学習を同時に進行できた
- Firebase のデプロイが非常に手軽で、個人開発でも短期間で公開を経験できた
- 今後の課題や拡張アイデア:
  - UIデザインの改善
  - 認証（ユーザー管理）機能の追加
  - 付箋の削除や色変更機能
